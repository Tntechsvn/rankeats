  ...
  <div class="container">
    <div class="front-search">
        ...
        <div class="col-xs-8 col-xs-offset-2">
          <div class="input-group syl-cus">
            <div class="input-group-btn search-panel">
              <button type="button" class="btn btn-custom input-lg" style="border-radius: 0px;"> <span id="search_concept">Find</span>  </button>
            </div>
      ...
      <input type="hidden" name="eat" id="searcheat_id" value="" />
            <div class="input-group-btn search-panel">
              <button type="button" class="btn btn-custom input-lg" style="border-radius: 0px;"> <span id="search_concept">In</span>  </button>
            </div>
...
<div class="container-fluid col-center">
<div class="container col-how">
  ...
  <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-h-info wow bounceInUp"> <i class="fa fa-check-circle fa-4x"></i>
    <h3>Vote</h3>
    <p>Vote for your favorite Eats in an area.</p>
  </div>
  <!-- /.col-sm-12 col-xs-12 col-md-4 col-lg-4 -->
  
  <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-h-info wow bounceInRight"> <i class="fa fa-comments fa-4x"></i>
    <h3>Review</h3>
...
<div class="container-fluid col-top">
    ...
    <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4 col-box wow fadeInUp animated featuredeats" style="visibility: visible; animation-name: fadeInUp;" data-toggle="modal" data-target="#myModal1">
        <div class="grid"> <a class="over-label" data-id="10" href="#">Fried Chicken</a> <a><img class="img-responsive" style="height: 300px;" src="images/fried_chicken.jpg" width="500" height="300" alt="Fried Chicken"> </a>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4 col-box wow fadeInUp animated featuredeats" style="visibility: visible; animation-name: fadeInUp;" data-toggle="modal" data-target="#myModal2">
        <div class="grid"> <a class="over-label" data-id="7" href="#">Pizza</a> <a><img class="img-responsive" style="height: 300px;" src="images/pizza.jpg" width="500" height="300" alt="Pizza"> </a>
          <!--<h3><a>Pizza</a></h3>-->
        </div>
      </div>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4 col-box wow fadeInUp animated featuredeats" style="visibility: visible; animation-name: fadeInUp;" data-toggle="modal" data-target="#myModal3">
        <div class="grid"> <a class="over-label" data-id="11" href="#">Burgers</a> <a><img class="img-responsive" style="height: 300px;" src="images/burger.jpg" width="500" height="300" alt="Burgers"> </a>
          <!--<h3><a>Burgers</a></h3>-->
        </div>
      </div>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4 col-box wow fadeInUp animated featuredeats" style="visibility: visible; animation-name: fadeInUp;" data-toggle="modal" data-target="#myModal4">
        <div class="grid"> <a class="over-label" data-id="12" href="#">Steaks</a> <a><img class="img-responsive" style="height: 300px;" src="images/steaks.jpg" width="500" height="300" alt="Steaks"> </a>
          <!--<h3><a>Steaks</a></h3>-->
        </div>
      </div>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4 col-box wow fadeInUp animated featuredeats" style="visibility: visible; animation-name: fadeInUp;" data-toggle="modal" data-target="#myModal5">
        <div class="grid"> <a class="over-label" data-id="13" href="#">Salmon</a> <a><img class="img-responsive" style="height: 300px;" src="images/Salmon.jpg" width="500" height="300" alt="Salmon"> </a>
          <!--<h3><a>Salmon</a></h3>-->
        </div>
      </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6 col-xs-12 col-md-4 col-lg-4 col-box wow fadeInUp animated featuredeats" style="visibility: visible; animation-name: fadeInUp;" data-toggle="modal" data-target="#myModal6">
          <div class="grid"> <a class="over-label" data-id="14" href="#">Spaghetti</a> <a><img class="img-responsive" style="height: 300px;" src="images/Spaghetti.jpg" width="500" height="300" alt="Spaghetti"> </a>
