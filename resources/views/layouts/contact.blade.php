				...
				<form id="formContact" action="{{route('createContact')}}" method="post" data-parsley-validate>
					...
					<div class="form-group">
						<div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input type="text" class="form-control" name="name_user_contact" id="inputYourname" placeholder="Your Name" data-parsley-required>
						</div>
						<span class="errors">{{$errors -> first('name_user_contact')}}</span>
					</div>
					<div class="form-group">
						<div class="input-group"> <span class="input-group-addon">@</span>
							<input type="text" class="form-control" name="email" id="inputEmail" placeholder="Email" data-parsley-required>							
						</div>
						<span class="errors">{{$errors -> first('email')}}</span>
					</div>
					<div class="form-group">
						<div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-info-sign"></span></span>
							<input type="text" class="form-control" name="subject" id="inputSubject" placeholder="Subject" data-parsley-required>							
						</div>
						<span class="errors">{{$errors -> first('subject')}}</span>
					</div>
					<div class="form-group">
						<textarea class="form-control" id="inputMessage" name="message" rows="3" placeholder="Message" data-parsley-required></textarea>
